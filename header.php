...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo( 'stylesheet_url' ); ?>?v=51" />
...
<div id="wrapper" class="hfeed">
    <div class="global-nav-bg"> 
		<nav class="global-nav">
				...
				<h2><a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>" class="ir unitPng">StateImpact</a></h2>
				...
				<ul class="global-utils">
					...
					<li><a href="/">About StateImpact</a> </li>
